...
{
    /// <inheritdoc />
    public partial class PopularArtistas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData("Artistas", new string[] { "Nome", "Bio", "FotoPerfil" }, new object[] { "Djavan", "Bio", "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png" });
